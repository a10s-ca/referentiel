...
| [contributionType](#contributionType ) | Identification des types de contribution.                                                                                                                                                                                                                                                                                                                            | Obligatoire (1..N) | Tableau d'objets de type [Term](../term ) |
| [contributeur](#contributeur )         | Identification du contributeur                                                                                                                                                                                                                                                                                                                                       | Obligatoire        | [Contributor](../contributor )            |
| [sequenceNumber](#sequenceNumber )     | Précision sur l'ordre de présentation des contributions (les nombres plus petits correspondent à des contributions qui doivent être présentées en premier).                                                                                                                                                                                                          | Optionnel          | -                                                    |
